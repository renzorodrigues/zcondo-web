  ...
  <LandingContainer>
    <header class="flex flex-col lg:flex-row justify-between items-center my-5">
      <div class="flex w-full lg:w-auto items-center justify-between">
        <a href="/" class="text-lg"><span class="font-bold text-slate-800">Zee</span><span
            class="text-slate-500">get</span>
        </a>
      ...
      <div>
        <div class="hidden lg:flex items-center gap-4">
          ...
          <LandingLink href="/auth/register" size="md">Sign up</LandingLink>
        </div>
      </div>
    </header>
  </LandingContainer>
